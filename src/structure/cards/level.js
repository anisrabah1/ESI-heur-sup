...
export default function Level({dataGlobal,setdata,set_dataPlus,set_dataPlus2,setShow,pushdata,AddURL}) {
...
const fetchsection = async () => {
  ...
  try {
      ...
      const response = await fetch(`${apiUrls.getUrl('getLevels')}${data._id}/sections`,{
        headers: {
...
const fetchsemesters = async () => {
    ...
    try {
        ...
        const response = await fetch(`${apiUrls.getUrl('getLevels')}${data._id}/semesters`,{
          headers: {
            "Content-type": "application/json; charset=UTF-8",
            Authorization: `Bearer ${token}`,
          },
  ...
  const fetchspeciality = async () => {
    ...
    try {
        ...
        const response = await fetch(`${apiUrls.getUrl('getLevels')}${data._id}/specialties  `,{
          headers: {
            "Content-type": "application/json; charset=UTF-8",
            Authorization: `Bearer ${token}`,
          },
  ...
  const Delete = async () => {
    ...
    try {
        ...
        const response = await fetch(`${apiUrls.getUrl('getLevels')}${data._id}`,{
          method:'DELETE',
          headers: {
            "Content-type": "application/json; charset=UTF-8",
            Authorization: `Bearer ${token}`,
