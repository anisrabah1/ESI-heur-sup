      ...
      <div className="content">
        <div className="container-System-param">
          <div className="cnt">
            ...
            {addingGrade && (
              <div className={addingGrade ? "custom-popup-container-SP" : ""}>
                <div className="custom-popup-content-SP">
                  ...
                  <div className="custom-form-content-SP">
                    <form
                      onSubmit={(e) => {
                        if (!updatingGrade) {
                          mySubmit(e, "positions", {
                            positionName,
                            amountPerSeance,
                          });
                        } else {
                          e.preventDefault();
                          myUpdate("positions", updatedgGrade._id, {
                            positionName,
                            amountPerSeance,
                          });
                        }
                      ...
                      <div className="group-in-form-SP">
                        <div className="box-SP">
                          ...
                          <input
                            ...
                            defaultValue={
                              updatingGrade ? updatedgGrade.positionName : ""
                            }
                          />
                        </div>
                        <div className="box-SP">
                          ...
                          <input
                            ...
                            defaultValue={
                              updatingGrade ? updatedgGrade.amountPerSeance : ""
                            }
                          />
                        </div>
                      </div>
            ...
            {addingSeanceType && (
              <div
                className={addingSeanceType ? "custom-popup-container-SP" : ""}
              >
                <div className="custom-popup-content-SP">
                  <div className="icon" onClick={handleClickClose}>
                    <FontAwesomeIcon
                    ...
                    <form
                      onSubmit={(e) => {
                        if (!updatingSeanceType) {
                          ...
                          e.preventDefault();
                          myUpdate("seanceTypes", updatedgSeanceType._id, {
                            seanceTypeName,
                            coefficient,
                            priority,
                          });
                      ...
                      <div className="group-in-form-SP">
                        <div className="box-SP">
                          ...
                          <input
                            ...
                            defaultValue={
                              updatingSeanceType
                                ? updatedgSeanceType.seanceTypeName
                                : ""
                            }
                          />
                        </div>
                        <div className="box-SP">
                          ...
                          <input
                            ...
                            defaultValue={
                              updatingSeanceType
                                ? updatedgSeanceType.coefficient
                                : ""
                            }
                        ...
                        <div className="box-SP">
                          <span onClick={() => console.log(updatedgSeanceType)}>
                            Priorité{" "}
                          </span>
                          <input
                            style={{ width: "50px", textAlign: "center" }}
            ...
            {addingOffDay && (
              <div className={addingOffDay ? "custom-popup-container-SP" : ""}>
                <div className="custom-popup-content-SP">
                  <div className="icon" onClick={handleClickClose}>
                    <FontAwesomeIcon
                      icon={faCircleXmark}
                  ...
                  <div className="custom-form-content-SP">
                    <form
                      onSubmit={(e) => {
                        if (!updatingOffDay) {
                          mySubmit(e, "offDayTypes", {
                            offDayTypeName,
                            personal,
                          });
                        } else {
                          e.preventDefault();
                          myUpdate("offDayTypes", updatedOffDay._id, {
                            offDayTypeName,
                            personal,
                          });
                        }
                      ...
                      <div className="group-in-form-SP">
                        <div className="box-SP">
                          ...
                          <input
                            ...
                            defaultValue={
                              updatingOffDay && updatedOffDay.offDayTypeName
                            }
                          />
                        </div>
                        <div className="box-SP">
                          ...
                          <Checkbox
                            checked={updatingOffDay && updatedOffDay.personal}
            ...
            <div className="sessionY">
              ...
              <div
                className={`details-param ${
                  openGrade ? "details-param-Opened" : ""
                }`}
              >
                {!grades ? (
                  <div className="indic-add">
                ...
                >
                  <div
                    className="add-icon"
                    onClick={handleClickAddingGrade}
                    style={{ width: "fit-content", margin: "6px 2px" }}
                  >
                    <lord-icon
                      src="https://cdn.lordicon.com/hqymfzvj.json"
                      trigger="hover"
            ...
            <div className="sessionY">
              ...
              <div
                className={`details-param ${
                  openSeanceType ? "details-param-Opened" : ""
                }`}
              >
                <div className="indic-add">
                  {!seanceType && (
                ...
                >
                  <div
                    className="add-icon"
                    onClick={handleClickAddingSeanceType}
                    style={{ width: "fit-content", margin: "6px 2px" }}
                  >
                    <lord-icon
                      src="https://cdn.lordicon.com/hqymfzvj.json"
            ...
            <div className="sessionY">
              ...
              <div
                className={`details-param ${
                  offDayOpen ? "details-param-Opened" : ""
                }`}
              >
                <div className="indic-add">
                  {!offDay && (
                    <div className="indication"> no off-Days types !</div>
                  )}
                </div>
                {offDay &&
                  offDay.map((item) => {
                ...
                >
                  <div
                    className="add-icon"
                    onClick={handleClickAddingOffDay}
                    style={{ width: "fit-content", margin: "6px 2px" }}
                  >
                    <lord-icon
                      src="https://cdn.lordicon.com/hqymfzvj.json"
