                  ...
                  <form
                    onSubmit={(e) => {
                      if (!updatingSession) {
                        ...
                        myUpdate("session", updatedSession._id, {
                          sessionName,
                          startDate,
                          endDate,
                          threshold,
                    ...
                    <div className="form-group">
                      ...
                      <div className="input-param">
                        ...
                        <input
                          ...
                          defaultValue={
                            updatingSession ? updatedSession.startDate : 0
                          }
                        />
                      </div>
                      <div className="input-param">
                        ...
                        <input
                          ...
                          defaultValue={
                            updatingSession ? updatedSession.endDate : 0
                          }
                        />
                      </div>
                      <div className="input-param">
                        ...
                        <input
                          ...
                          defaultValue={
                            updatingSession ? updatedSession.threshold : 0
                          }
                        />
                      </div>
                    </div>
                  ...
                  <div className="session-cardYY">
                    ...
                    <div className="from-to">
                      ...
                      <div className="toYY">
                        ...
                        <input
                          type="date"
                          value={item.endDate.substring(0, 10)}
                        />
                      </div>
                      <button
                        onClick={(e) => {
