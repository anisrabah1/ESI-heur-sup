            ...
            const fetchData = async (whereFetch,teacherSessionId,dataToFetch,setObject) => {
              ...
              try {
               console.log("Hello from the use effect")
                  ...
                  const response = await fetch(`http://${apiUrl}:3001/api/v1/${whereFetch}/${teacherSessionId}/${dataToFetch}`, {
                      method: 'GET',
                      headers: {
...
useEffect(()=>{
    ...
    try {
        const token = Cookies.get("token");
        let response = await fetch('http://'+apiUrl+':3001/api/v1/departments', {
            method: 'GET',
            headers: {
              'Content-type': 'application/json; charset=UTF-8',
              Authorization :`Bearer ${token}`
        ...
        if (!response.ok) { 
         ...
         response = await fetch('http://'+apiUrl+':3001/api/v1/seanceTypes', {
            method: 'GET',
            headers: {
              'Content-type': 'application/json; charset=UTF-8',
              Authorization :`Bearer ${token}`
...
const getLevel = async (depId)=>{
    try {
        const token = Cookies.get("token");
        const response = await fetch(`http://${apiUrl}:3001/api/v1/departments/${depId}/levels`, {
            method: 'GET',
            headers: {
              'Content-type': 'application/json; charset=UTF-8',
              Authorization :`Bearer ${token}`
...
const getSalles = async (depId) => {
    try {
      const token = Cookies.get("token");
      const response = await fetch(`http://${apiUrl}:3001/api/v1/departments/${depId}/rooms`, {
        method: 'GET',
        headers: {
          'Content-type': 'application/json; charset=UTF-8',
          Authorization: `Bearer ${token}`
...
const getSpecialties = async (lvlID)=>{
    try {
        const token = Cookies.get("token");
        const response = await fetch(`http://${apiUrl}:3001/api/v1/levels/${lvlID}/specialties`, {
            method: 'GET',
            headers: {
              'Content-type': 'application/json; charset=UTF-8',
              Authorization :`Bearer ${token}`
...
const getSemesters = async (str,parentID)=>{
    ...
    try {
        const token = Cookies.get("token");
        const response = await fetch(`http://${apiUrl}:3001/api/v1/${str}/${parentID}/semesters`, {
            method: 'GET',
            headers: {
              'Content-type': 'application/json; charset=UTF-8',
              Authorization :`Bearer ${token}`
...
const getSections = async (str,parentID)=>{
    ...
    try {
        const token = Cookies.get("token");
        const response = await fetch(`http://${apiUrl}:3001/api/v1/${str}/${parentID}/sections`, {
            method: 'GET',
            headers: {
              'Content-type': 'application/json; charset=UTF-8',
              Authorization :`Bearer ${token}`
...
const getGroupe = async (parentID)=>{
    ...
    try {
        const token = Cookies.get("token");
        const response = await fetch(`http://${apiUrl}:3001/api/v1/sections/${parentID}/groups`, {
            method: 'GET',
            headers: {
              'Content-type': 'application/json; charset=UTF-8',
              Authorization :`Bearer ${token}`
...
const getSubject = async (parentID)=>{
    ...
    try {
        const token = Cookies.get("token");
        const response = await fetch(`http://${apiUrl}:3001/api/v1/semesters/${parentID}/subjects`, {
            method: 'GET',
            headers: {
              'Content-type': 'application/json; charset=UTF-8',
              Authorization :`Bearer ${token}`
...
const [wait,setWait] = useState(false);
            ...
            try {
                setIsLoading(true);
                const token = Cookies.get("token");
                const response = await fetch('http://'+apiUrl+':3001/api/v1/teacherSessions/662c1513ba129bf7b1cb438f/seances', {
                    method: 'POST',
